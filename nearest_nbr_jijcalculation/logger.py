...
f_handler = logging.FileHandler(configJson['process_tag']+'_'+'workflow.log')
...
jij_calc_f_handler = logging.FileHandler(configJson['process_tag']+'_'+'jij_calc.log')
...
jij_nbr_f_handler = logging.FileHandler(configJson['process_tag']+'_'+'jij_nbr.log')
